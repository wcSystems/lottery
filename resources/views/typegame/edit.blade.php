...
@section('content')
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Editar <span class="fw-300"><i>Juego</i></span>
                </h2>
            </div>
                        ...
                        <div class="row">
                            <div class="col mb-15">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="@error("name") is-invalid @enderror form-control" value="{{$game->description}}" placeholder="Nombre" required>
